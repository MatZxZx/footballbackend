...
class WeekController {
  ...
  static async get(req, res) {
    try {
      ...
      if (!weekFound)
        return res.json({ message: 'La semana no existe', exists: false })
      return res.json({ ...weekFound, message: 'La semana existe', exists: true })
    } catch (e) {
      console.log(e)
  ...
  /*
    Al cerrar la semana se actualizan las transferencias de todos los usuarios
    ...
    Desactivar las transferencias ilimitadas
  ...
  */
  static async putToClose(req, res) {
    ...
    try {
      ...
      // await UserModel.disableManyUnlimitedTransfers()
